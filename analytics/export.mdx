...
<Steps>
  ...
  <Step title="Click Refresh">
    Select the **Sync **button in the Analytics header. Hivra queues an ingestion request to each connected platform's API. Select the **Sync** button in the Analytics header. Hivra queues an ingestion request to each connected platform's API.
  </Step>
