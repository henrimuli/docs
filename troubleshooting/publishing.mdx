...
<Steps>
  <Step title="Check connection health">
    Go to **Integrations** and review the health indicator for each account targeted by the post. An account showing **Attention/Issue **means the token has expired or been revoked. Hivra cannot publish to a disconnected account. See [Troubleshoot connection issues](/troubleshooting/connections) for how to reconnect. Go to **Integrations** and review the health indicator for each account targeted by the post. An account showing **Attention/Issue** means the token has expired or been revoked. Hivra cannot publish to a disconnected account. See [Troubleshoot connection issues](/troubleshooting/connections) for how to reconnect. Go to **Integrations** and review the health indicator for each account targeted by the post. An account showing **Attention/Issue** means the token has expired or been revoked. Hivra cannot publish to a disconnected account. See [Troubleshoot connection issues](/troubleshooting/connections) for how to reconnect.
  </Step>
