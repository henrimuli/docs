---
title: "Fix Common Publishing Errors and Failed Posts"
description: "Resolve upload rejections, missed schedules, partial publishes, and quota limits so your content reaches every platform without interruption."
---
...
<Steps>
  <Step title="Check connection health">
    Go to **Integrations** and review the health indicator for each account targeted by the post. An account showing **Attention** means the token has expired or been revoked. Hivra cannot publish to a disconnected account. See [Troubleshoot connection issues](/troubleshooting/connections) for how to reconnect.
  </Step>
