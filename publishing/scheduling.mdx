...
<Steps>
  ...
  <Step title="Review and confirm">
    A summary shows which connected accounts will receive the post and the scheduled timestamp. Confirm to lock the schedule. The job moves to **Scheduled** state in the Library immediately.
  </Step>
</Steps>
...
<Warning>
  Daylight saving time transitions can shift how a local time label appears in the Library. Before a major campaign launch, confirm the scheduled time by checking the details modal on the Library card — it displays the ISO timestamp so there is no ambiguity.
</Warning>
...
Open **Calendar** from the sidebar to see a week-by-week or month-by-month view of everything scheduled across your connected accounts. Click any scheduled item in the Calendar to jump directly to its Library card, where you can edit the schedule or check job details.
