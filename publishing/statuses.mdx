...
sidebarTitle: "Publish Job Statuses"
---
...
<Note>
  On the Free plan, the Library only keeps post history for **7 days**. Jobs older than that — including Published, Partial, and Failed jobs — are removed from the Library automatically. A banner in the Library reminds Free plan users of this limit. Upgrade to Creator or Business for unlimited history.
</Note>
