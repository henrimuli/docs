...
<Steps>
  <Step title="Create in the Composer">
    Click **New Post** in the sidebar to open the **Composer**. Upload one or more MP4 or MOV files, select the connected accounts you want to reach, write your captions, set thumbnails, and configure any platform-specific settings. The Composer persists your work locally so your draft survives a browser refresh.
  </Step>
  <Step title="Choose a publish mode">
    At the bottom of the Composer, pick how you want to proceed:
...
| **Queued / Publishing** | The job is in the publish queue or actively being sent to platforms. |
...
<CardGroup cols={2}>
  <Card title="Composer" href="/publishing/composer" icon="pen-to-square">
    Upload video, write captions, pick platforms, and choose your publish mode.
  </Card>
  <Card title="Scheduling" href="/publishing/scheduling" icon="calendar">
    Set a future publish time and let Hivra handle automatic cross-posting.
  </Card>
  <Card title="Bulk upload" href="/publishing/bulk-upload" icon="layer-group">
    Drop multiple video files in one session and publish them as separate jobs.
  </Card>
  <Card title="Approvals" href="/publishing/approvals" icon="circle-check">
